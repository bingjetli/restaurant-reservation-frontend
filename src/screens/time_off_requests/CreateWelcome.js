...
export default function({route, navigation}){
    ...
    function goToNextScreen(){
        navigation.navigate({
            name:'time-off-requests-create-name',
        });
    }
    ...
    return (<SafeAreaView style={[global_styles.fullView, setup_styles.mainView]}>
        ...
        <View style={[global_styles.fullCenteringView, setup_styles.bodyView]}>
            ...
            <Text style={[global_styles.bodyText, setup_styles.bodyText]} >This setup will guide you through the process of creating a new time-off request.</Text>
